...
export class TransactionsService {
    private transactionsData = signal<Transaction[]>([
        ...
        { id: '38', date: '2026-03-07', name: 'English', amount: 125.00, category: 'Income', transaction_status: 'COMPLETED', details: '' },
        { id: '39', date: '2026-03-02', name: 'CIM', amount: 2400.00, category: 'Income', transaction_status: 'COMPLETED', details: 'monthly recurring' }
    ]);
